...
public class FragmentAccompanimentMenuBindingImpl extends FragmentAccompanimentMenuBinding implements com.example.lunchtray.generated.callback.OnClickListener.Listener {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.accomFragment == variableId) {
            setAccomFragment((com.example.lunchtray.ui.order.AccompanimentMenuFragment) variable);
        }
    ...
    public void setAccomFragment(@Nullable com.example.lunchtray.ui.order.AccompanimentMenuFragment AccomFragment) {
        this.mAccomFragment = AccomFragment;
        synchronized(this) {
            mDirtyFlags |= 0x2L;
        }
        notifyPropertyChanged(BR.accomFragment);
        super.requestRebind();
    }
    ...
    protected void executeBindings() {
        ...
        com.example.lunchtray.ui.order.AccompanimentMenuFragment accomFragment = mAccomFragment;
    ...
    public final void _internalCallbackOnClick(int sourceId , android.view.View callbackArg_0) {
        switch(sourceId) {
            case 4: {
                ...
                // accomFragment != null
                boolean accomFragmentJavaLangObjectNull = false;
                // accomFragment
                com.example.lunchtray.ui.order.AccompanimentMenuFragment accomFragment = mAccomFragment;



                accomFragmentJavaLangObjectNull = (accomFragment) != (null);
                if (accomFragmentJavaLangObjectNull) {


                    accomFragment.cancelOrder();
                }
                break;
            }
            case 2: {
